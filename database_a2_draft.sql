...
DROP TABLE IF EXISTSMUTUAL_FUND CASCADE;
DROP TABLE IF EXISTSclosing_price CASCADE;
DROP TABLE IF EXISTS"LOCATION" CASCADE;
DROP TABLE IF EXISTSUSERS CASCADE;
DROP TABLE IF EXISTSCUSTOMER CASCADE;
DROP TABLE IF EXISTSADMINISTRATOR CASCADE;
DROP TABLE IF EXISTSPREFERS CASCADE;
DROP TABLE IF EXISTSOWNS CASCADE;
DROP TABLE IF EXISTSTRANSACTIONS CASCADE;
DROP TABLE IF EXISTSDEPOSIT_TRANSACTION CASCADE;
DROP TABLE IF EXISTSINVESTMENT_TRANSACTION CASCADE;
DROP TABLE IF EXISTSDEPOSIT_TRANS CASCADE;
DROP TABLE IF EXISTSPROFOLIO_ACTION CASCADE;
