...
DROP TABLE MUTUAL_FUND CASCADE;
DROP TABLE COMPANGY CASCADE;
DROP TABLE closing_price CASCADE;
...
DROP TABLE DEPOSIT_TRANSACTION CASCADE;
DROP TABLE INVESTMENT_TRANSACTION CASCADE;
DROP TABLE DEPOSIT_TRANS CASCADE;
DROP TABLE PROFOLIO_ACTION CASCADE;
...
CREATE TABLE IF NOT EXISTS closing_price  /*weak entity of mutual_fund*/
   (
    ...
    FOREIGN KEY (SYMBOL) REFERENCES MUTUAL_FUND ON DELETE CASCADE,  
...
INSERT INTO DEPOSIT_TRANS (TRANS_ID,CUSTOMER_ID,t_date,AMOUNT)
    VALUES (6,'customerid','2019-04-01',300);
